...
export const DisabledFields: string[] = [
  "wwuid",
  "username",
  "views",
  "updated_at",
];
export const PrivateFields: string[] = DisabledFields.concat([
  "full_name",
  "gender",
  "privacy",
]);
...
export const SearchableFields = {
  majors: [
    ...
    "Masters of Science in Biology (MS)",
    ...
    "New Media Imaging",
    "Nursing",
    "Operation managemnent",
    "Orthotics and Prosthetics",
    "Outdoor recreation",
    "Photojournalism",
    "Physical Education",
    "Physical Education (Physiology Concentration)",
    "Physics",
    ...
    "Pre-Dental Hygiene",
    "Pre-Dentistry",
    "Pre-Emergency Medical Care/Cardiopulmonary Sciences",
    ...
    "Pre-Speech-Lang. Pathology and Audiology",
    "Pre-Veterinary Science",
    "Pre-Wed",
    "Pre-world domination",
    ...
    "Social Welfare",
    "Social Work",
    "Social Work, Child LIfe Specialist",
    "Sociology",
    "Spanish",
    "Special Education",
  ...
  minors: [
    ...
    "Voice",
    "Web Design and Development",
    "Whatever I can get for 240 credits",
    "Wildlife Ecology",
  ],
} as const;
