...
@Component({
  ...
  template: `
    ...
    <div *ngIf="currentUser" id="jobApps" class="container">
      <a
        *ngIf="!hasInsufficientPermissions"
        class="btn btn-primary mb-5"
        [routerLink]="'/jobs/admin/edit/' + formID"
        >Edit this Form</a
      >
      <card-list [cards]="cards"></card-list>
      <div
        *ngIf="applications?.length == 0"
        class="col col-sm-12 col-md-6 col-lg-3 text-center"
      >
    ...
    <div class="container" *ngIf="!currentUser">
      <p>
        This page can only be viewed by someone logged in, please click the
        button to log in:
      </p>
