...
export class AdminEditComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    private tas: TypeAheadRequestService,
  ...
  getJobData() {
    this.rs
      .get("/forms/job/view/" + this.jobID)
      .subscribe((jobData: { form: JobView }) => {
  ...
  submitForm() {
    ...
    this.rs
      .post("/forms/job/edit/" + this.jobID, formData, null, "urlencoded")
      .subscribe(
        (data) => {
